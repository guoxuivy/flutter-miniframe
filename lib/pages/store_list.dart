import 'package:agent/pages/section/store_list_section.dart';
...
class StoreListPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _StoreListView();
}
...
/// 视图构建逻辑
class _StoreListView extends State<StoreListPage> {
...
class _DropDownFilterState extends State<DropDownFilter>
  ...
  void onSubmit() {
    trace('提交');
    // 2种方式 测试
    var param = {"first": "Dart", "page": 1, "abc": 'abc'};
    widget.submit(param);
    context.read(paramProvider).change(param);
    controller.reverse();
    triggerIcon(widget.buttons[atIndex]);
    triggerMask();
  }
